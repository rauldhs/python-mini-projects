"""
Cool python script to spam rickroll gif windowses
"""
...
def main():
    """Spams rickroll giff windows through create_window()"""

    root = Tk()
    root.withdraw()

    gif = load_gif(
        "https://media.tenor.com/q0Ejci9EQhcAAAAj/rick-astley-rick-roll.gif")
